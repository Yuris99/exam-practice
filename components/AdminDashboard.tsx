...
export function AdminDashboard({ userId, onQuestionSaved }: { userId: string; onQuestionSaved: (question: Question) => void }) {
  ...
  function beginEditing(report: AdminQuestionReport) {
    if (!report.questionSnapshot) return;
    const question = report.questionSnapshot;
