...
function validateBackup(value: unknown): StudyState {
  ...
  const knownKeys = ["answers", "bookmarks", "aiExplanations", "activeTest", "testResults", "customQuestions", "activePractice", "activities", "notes", "noteUpdatedAt", "questionReports", "aiExplanationReports", "theoryProgress"];
